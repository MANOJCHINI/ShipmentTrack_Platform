...
import com.shiptrack.auth.security.JwtAuthenticationFilter;
import com.shiptrack.auth.security.OAuth2LoginSuccessHandler;
 ...
 * - Stateless session (no cookies/session tracking)
 * - CSRF disabled (JWT-based auth)
 * - Public auth endpoints + protected everything else
 * - RBAC via @PreAuthorize (enabled by @EnableMethodSecurity)
