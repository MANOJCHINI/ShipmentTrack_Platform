          ...
          <Card className="overflow-hidden">
            ...
            <CardContent className="p-4">
              ...
              <div className="mt-3 flex items-center justify-between text-xs text-muted-foreground">
                ...
                <span className="flex items-center gap-1">
                  <Navigation className="h-3 w-3" /> {shipment.destination.name}
                </span>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <DetailRow
                ...
                value={`${relativeDay(shipment.estimatedDelivery)} · ${formatDateTime(
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <DetailRow
                icon={Weight}
                label="Weight"
                value={`${formatNumber(shipment.weightKg)} kg`}
              />
              <DetailRow
                icon={Boxes}
                label="Pieces"
